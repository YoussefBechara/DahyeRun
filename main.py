...
warning_rect = warning_TEXT.get_rect(center=(screen_width//2, screen_height//5))
def warning():
...
def shop(coins_collected,bg):
    while True:
        ...
        coins_TEXT = get_font(35).render(f"You have:{coins_collected}", True, "WHITE")
        coins_RECT = coins_TEXT.get_rect(center=(720,50))
        SCREEN.blit(coins_TEXT, coins_RECT)
        SCREEN.blit(coin_img, (950, 28))

        SCREEN.blit(NORTHERN_BG_img,(20,300))
        northern_button = Button(image=quit_img,pos=(160,375), text_input="200", font=get_font(30), base_color="#d7fcd4", hovering_color="green")
        
        
        SCREEN.blit(lightning_BG_img,(20,100))
        lightning_button = Button(image=quit_img,pos=(160,175), text_input="100", font=get_font(30), base_color="#d7fcd4", hovering_color="green")
        
        SCREEN.blit(sunset_BG_img,(340,100))
        sunset_button = Button(image=quit_img,pos=(480,175), text_input="150", font=get_font(30), base_color="#d7fcd4", hovering_color="green")
        
        SCREEN.blit(winter_BG_img,(340,300))
        winter_button = Button(image=quit_img,pos=(480,375), text_input="500", font=get_font(30), base_color="#d7fcd4", hovering_color="green")
        
        SCREEN.blit(spooky_BG_img,(660,100))
        spooky_button = Button(image=quit_img,pos=(800,175), text_input="300", font=get_font(30), base_color="#d7fcd4", hovering_color="green")
